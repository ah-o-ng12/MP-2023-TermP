...
class QuizBoard : AppCompatActivity() , View.OnClickListener {
    private lateinit var binding:QuizBoardBinding
            ...
            if (selectedOption != 0){
                ...
                when{
                    ...
                    currentPosition <= questionList.size -> {
                        ...
                        //결과 액티비티로 넘어가는 코드
                        val intent = Intent(this@QuizBoard, QuestionResult::class.java)
